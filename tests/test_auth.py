...
from routers.auth import SECRET_KEY, ALGORITHM, bcrypt_context
...
async def test_get_current_user_token():
    ...
    assert user == {'username': 'sikora', 'id': 1, 'role': 'admin'}
...
async def test_get_current_user_missing_payload():
    ...
    try:
        ...
        assert excinfo.detail == 'Could not validate credentials'
